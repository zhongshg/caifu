                                ...
                                <tbody>
                                    <c:forEach items="${pu.list}" var="powers">
                                        <tr>
                                            ...
                                            <td>${powers.url}</td>
                                            <td>${powers.remark}</td>
                                            <td id="orders_${powers.id}">
                                                ${powers.orders}
                                                <input type="button" value="修改" onclick="javascript:updateorders('${powers.id}', '${powers.orders}')"/>
                                            </td>
                                            <td>
                                                <!-- Icons -->
...
<!--                <div class="notification attention png_bg"> <a href="#" class="close"><img src="${pageContext.servletContext.contextPath}/resources/images/icons/cross_grey_small.png" title="Close this notification" alt="close" /></a>
        ...
        <script>
                function updateorders(id, orders) {
                    orders = window.prompt("请输入排序号：", orders);
                    $.post("${pageContext.servletContext.contextPath}/servlet/PowersServlet?method=updateorders", {"id": id, "orders": orders}, function(result) {
                        $("#orders_" + id).html(orders);
                    });
                }
        </script>
    </body>
