                ...
                <div id="page-content">
                    <div id="img-content" class="rich_media_area_primary">
                        ...
                        <div class="rich_media_meta_list">
                            ...
                            <a class="rich_media_meta rich_media_meta_link rich_media_meta_nickname" href="javascript:void(0);" id="post-user">${wx.name}</a>
                            <!--<span class="rich_media_meta rich_media_meta_text rich_media_meta_nickname">中建信和·山东</span>-->
                        </div>
                        <!--class="rich_media_content"-->
                        <div id="js_content"><p>${news.content}</p></div>
                        ...
                        <div class="rich_media_tool" id="js_toobar">
                            <div id="js_read_area" class="media_tool_meta tips_global meta_primary">阅读 <span id="readNum">${news.viewcounts}</span></div>
