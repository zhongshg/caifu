            ...
            <div class="rich_media_inner">
                <div id="page-content">
                    <div id="img-content" class="rich_media_area_primary">
                        <h2 class="rich_media_title" id="activity-name">                        天澜科技                     </h2>
                                ...
                                <c:forEach items="${pu.list}" var="newstypes">
                                    <li>
                                        <c:if test="${0==newstypes.sign}" var="flag">
                                            <a href="${pageContext.servletContext.contextPath}/ForeServlet?method=newslist&sid=${newstypes.sid}&id=${newstypes.id}"> <img src="${pageContext.servletContext.contextPath}${newstypes.img}" style="width: 30%;" /> <i>${newstypes.name}</i> </a>
                                            </c:if>
                                            <c:if test="${!flag}">
                                            <a href="${pageContext.servletContext.contextPath}/ForeServlet?method=newstypeslist&sid=${newstypes.sid}&id=${newstypes.id}"> <img src="${pageContext.servletContext.contextPath}${newstypes.img}" style="width: 30%;"/> <i>${newstypes.name}</i> </a>
                                            </c:if>
                                    </li>
                                </c:forEach>
                            </ul>
                ...
                <p style="text-align: center;">${pu.forestyle}</p>
