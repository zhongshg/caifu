...
function DelImg1(o,sr){
		o.style.display='none';
		var pts=document.getElementById("ViewImg").value;
		var npts='';
		var arr=pts.split(',');
		...
		document.getElementById("ViewImg").value=npts;
		
}

function addImage1(src) {
	
	document.getElementById("thumbnails1").innerHTML='<li><img src="'+src+'" width="80" height="80" /><br /><a onclick="DelImg1(this.parentNode,\''+src+'\')" href="javascript:void(0)">删除</a></li>';
	//alert(document.getElementById('Photos').value);
	document.getElementById("ViewImg").value=src;
	if (newImg.filters) {
		try {
...
function FileProgress1(file, targetID) {
	...
	if (!this.fileProgressWrapper) {
		...
		fadeIn1(this.fileProgressWrapper, 0);
