                ...
                <td>
                    <form method="get" action="?">
                        ...
                        <select name="selectsign" id="selectsign">
                            ...
                            <option value="3" <%=3 == selectsign ? "selected='selected'" : ""%>>用户ID</option>
                        </select>
...
<!--                    <td align="center" bgcolor="#FDFDFD"><%=df.getFieldValue("UserId")%></td>
                    ...
                    <td align="center" bgcolor="#FDFDFD" id="Sts">
                        <%
                            switch (df.getInt("Sts")) {
                                case 0:
                    ...
                    <td bgcolor="#FDFDFD"><div align="center"><input type="button" onclick="location.href = 'order_detail.jsp?id=<%=id%>'" value="详情"/></div></td>

                    <td bgcolor="#FDFDFD"><div align="center">
                            订单号：<input type='text' id='ShipNo_<%=id%>' value="<%=df.getFieldValue("ShipNo")%>"/><br/>
                            快递公司：<input type='text' id='ShipName_<%=id%>' value="<%=df.getFieldValue("ShipName")%>"/><br/>
                            <input type='button' id='shipbutton' name='shipbutton' a='<%=id%>' value="修改" />
                        </div></td>
<!--                    <td bgcolor="#FDFDFD"><div align="center"><%=df.getFieldValue("ShipName")%></div></td>
                  <td bgcolor="#FDFDFD"><div align="center"><%=df.getFieldValue("isShoudan")%></div></td>-->
                    <td bgcolor="#FDFDFD">
                        ...
                        <input type='button' value="现在发货" onclick="javascript:send('<%=id%>', '<%=wx.get("id")%>');"/><br/>
                        <input type='button' value="退货" onclick="javascript:backthing('<%=id%>', '<%=wx.get("id")%>');"/>
                    </td>
                </tr>
                <%
                    }
