    ...
    <body>
        ...
        <%            ArrayList list = null;
            ...
            if (act != null && act.equals("do")) {
                ...
                // boolean bl = DaoFactory.getProductDAO().add(ProCode, SuserId, SuserName, Rid, Pid, Cid, BaoJian, GongNeng, RenQun, JiXing, JiangShi, WebDescr, WebKeywords, WebTitle, Title, Abbreviation, Keywords, Descr, MeasurId, Remarks, YongTu, IsSale, BrandId, IsShelves, ViewImg, Supplier, Photos, Price, PriceM, Content, AddTime, ModTime, Shelves, PSts, Tags, 0, IsShi, BeginTime, EndTime);
                ...
                boolean bl = DaoFactory.getProductDAO().mod(id, ProCode, SuserId, SuserName, Rid, Pid, Cid, BaoJian, GongNeng, RenQun, JiXing, JiangShi, WebDescr, WebKeywords, WebTitle, Title, Abbreviation, Keywords, Descr, MeasurId, Remarks, YongTu, IsSale, BrandId, IsShelves, ViewImg, Supplier, Photos, Cate, Photo, Price, PriceM, Content, ModTime, Shelves, PSts, IsNew, IsRem, Tags, SaleNum, IsShi, BeginTime, EndTime, KuaiDi, wxid, distributionmoney, distributionfirstdiscount, distributionseconddiscount, distributionthirddiscount, distributiontype, propertys);
                ...
                if (bl) {
                    out.print("<p align=\"center\">成功修改!<br /><a href=\"javascript:history.go(-2)\">继续修改</a>&nbsp;&nbsp;<a href=\"p_manage.jsp\">商品管理</a></p>");
                } else {
                ...
                if (df != null) {
                    String propertysDF = df.getFieldValue("propertys");
                    propertysDF = null != propertysDF ? propertysDF : "";
                    session.setAttribute("propertysDF", propertysDF);
                    //1.初始化属性totalstr
                    int signid = 0;
                    String totalstr = new PublicService().initPsv(signid, df, wx);
        %>
        <br />
        <form id="addCategory" name="addCategory" method="post" action="?act=do&id=<%=id%>" onSubmit="return check(this);">
            <input type="hidden" name="wxid" value="<%=df.getFieldValue("wxid")%>"/>
            <%--2.设置隐藏域--%>
            ...
            <table width="98%" height="25" border="0" align="center" cellpadding="2" cellspacing="0" class="black_border">
                <tr>
                    <td height="25" colspan="2" bgcolor="#3872b2"><div align="center" class="style1"><strong><span class="style2">
                                    修改商品</span></strong></div></td>
                </tr>
                <tr>
                    <td width="135" bgcolor="#FDFDFD"><div align="right">商品编号：</div></td>
                    <td width="828" bgcolor="#FDFDFD"><div align="left">
                            <input name="ProCode" type="text" id="ProCode" style="width:246px; border:1px solid #666666;" maxlength="250" value="<%=df.getString("ProCode")%>" />
                        </div></td>
                </tr>
                <tr>
                    <td width="135" bgcolor="#FDFDFD"><div align="right">商品名称：</div></td>
                    <td width="828" bgcolor="#FDFDFD"><div align="left">
                            <input name="Title" type="text" id="Title" style="width:246px; border:1px solid #666666;" maxlength="250" value="<%=df.getString("Title")%>"/>
                        </div></td>
                </tr>
                <!--                <tr>
                                    <td width="135" bgcolor="#FDFDFD"><div align="right">商品简称：</div></td>
                                    <td width="828" bgcolor="#FDFDFD"><div align="left">
                                            <input name="Abbreviation" type="text" id="Abbreviation" style="width:246px; border:1px solid #666666;" maxlength="250" value="<%=df.getString("Abbreviation")%>"/>
                                        </div></td>
                                </tr>-->
                <!--                <tr>
                                    <td width="135" bgcolor="#FDFDFD"><div align="right">商家账号：</div></td>
                                    <td width="828" bgcolor="#FDFDFD"><div align="left">
                                            <input name="SuserId" type="text" id="SuserId" style="width:246px; border:1px solid #666666;" maxlength="250" value="15254139923" />（*商家手机号）
                                        </div></td>
                                </tr>-->
                <!--                <tr>
                                    <td width="135" bgcolor="#FDFDFD"><div align="right">商家名称：</div></td>
                                    <td width="828" bgcolor="#FDFDFD"><div align="left">
                                            <input name="SuserName" type="text" id="SuserName" style="width:246px; border:1px solid #666666;" maxlength="250" value="万巷坊"/>（*商家名称）
                                        </div></td>
                                </tr>-->
                ...
                <tr>
                    ...
                    <td bgcolor="#FDFDFD"><input name="ViewImg" type="text" id="ViewImg" style="width:246px; border:1px solid #666666;" maxlength="250" value="<%=df.getString("ViewImg")%>" />
                ...
                <!--                <tr>
                                    <td align="right" bgcolor="#FDFDFD">产品图片：<br/>640*370</td>
                                    <td bgcolor="#FDFDFD">
                
                                        <textarea name="Photos" id="Photos" style="display:none;"><%=df.getString("Photos")%></textarea>
                                        <div id="thumbnails">
                <%
                    String pts1 = df.getString("Photos");
                    if (pts1 != null && !pts1.equals("")) {
                        String[] par1 = pts1.split(",");
                        for (int i = 1; i < par1.length; i++) {
                            out.print("<li><img src=\"" + par1[i] + "\" width=\"80\" height=\"80\" /><br /><a onclick=\"DelImg(this.parentNode,\'" + par1[i] + "\')\" href=\"javascript:void(0)\">删除</a></li>");
                        }
                    }
                %>
            </div>       
            ...
            <span id="spanButtonPlaceholder" style="cursor:pointer;"></span>
                ...
                <tr>
                    ...
                    <td bgcolor="#FDFDFD"><input name="Price" type="text" id="Price" value="<%=df.getFloat("Price")%>" size="12" onclick="if (this.value == '0.00')
                this.value = '';" onblur="if (this.value == '')
                this.value = '0.00';" />
                        元 
                        <!--                        (市场价格：
                                                <input name="PriceM" type="text" id="PriceM" value="<%=df.getFloat("PriceM")%>" size="12" onclick="if (this.value == '0.00')
                                        this.value = '';" onblur="if (this.value == '')
                                        this.value = '0.00';" />
                                                元)-->
                    </td>
                ...
                <tr>
                    ...
                    <td width="828" bgcolor="#FDFDFD"><div align="left">
                            <select name="Cid" size="1" id="Cid" onChange="GetEduArea(this.options[this.selectedIndex].value, 0)">
                                <%=DaoFactory.getCategoryDAO().getSelectTree("", df.getInt("Cid"), 0, wx.get("id"))%>
                            </select>
                ...
                <!--                <tr>
                                    ...
                                    <td bgcolor="#FDFDFD"><label>
                                            <select name="PSts" id="PSts">
                                                <option value="1" <%if (df.getInt("PSts") == 1) {
                                                        out.print(" selected=\"selected\"");
                                                    }%>>正常</option>
                                                <option value="2" <%if (df.getInt("PSts") == 2) {
                                                        out.print(" selected=\"selected\"");
                                                    }%>>暂停出售</option>
                                            </select>是否上架
                                            <select name="IsShelves" id="IsShelves">
                                                <option value="1" <%if (df.getInt("IsShelves") == 1) {
                                                        out.print("selected=\"selected\"");
                                                    }%> >是</option>
                                                <option value="2" <%if (df.getInt("IsShelves") == 2) {
                                                        out.print("selected=\"selected\"");
                                                    }%>>否</option>
                                            </select>
                
                                            排序：  <input name="SaleNum" type="text" id="SaleNum" value="<%=df.getInt("SaleNum")%>" size="12"                                           />
                                        </label></td>
                                </tr>-->
                <tr>
                    <td align="right" bgcolor="#FDFDFD">排序：</td>
                    <td bgcolor="#FDFDFD"><label>
                            <input name="SaleNum" type="text" id="SaleNum" value="<%=df.getInt("SaleNum")%>" size="12"/>
                        </label></td>
                </tr>
                ...
                <tr>
                    ...
                    <td width="828" bgcolor="#FDFDFD">
                        <%
                            List<DataField> firstPropertysList = (List<DataField>) DaoFactory.getPropertysDaoImplJDBC().getList("0", signid, df.getFieldValue("SuserId"));
                        %>
                        ...
                        <div align="left" name="xsshuxing" id="xsshuxing" style="border:1px solid #FFA500;min-height: 50px;display: none;padding: 10px; " >
                            ...
                            <select name="shuxing" size="1" id="shuxing" onChange="shuxingsx(this.options[this.selectedIndex].value, <%=signid%>, <%=id%>)">
                            ...
                            <div style="margin-top: 10px;">
                                <input name="tjshuxing" id="tjshuxing" value="确定" type="button" onclick="shuxingtj(<%=signid%>,<%=id%>)"/>
                ...
                <tr>
                    ...
                    <td width="828" bgcolor="#FDFDFD"><div align="left">
                            ...
                            <input name="distributiontype" type="radio" style="width:66px; border:1px solid #666666;" maxlength="250" value="1" <%=1 == df.getInt("distributiontype") ? "checked=\"checked\"" : ""%> />按比例
                        </div></td>
                </tr>
                <!--                <tr>
                                    <td width="135" bgcolor="#FDFDFD"><div align="right">分销金额：</div></td>
                                    <td width="828" bgcolor="#FDFDFD"><div align="left">
                                            <input name="distributionmoney" type="text" id="distributionmoney" style="width:246px; border:1px solid #666666;" maxlength="250" value="<%=df.getFieldValue("distributionmoney")%>"/>
                                        </div></td>
                                </tr>-->
                <tr>
                    <td width="135" bgcolor="#FDFDFD"><div align="right">一级分销：</div></td>
                    <td width="828" bgcolor="#FDFDFD"><div align="left">
                            <input name="distributionfirstdiscount" type="text" id="distributionfirstdiscount" style="width:246px; border:1px solid #666666;" maxlength="250"  value="<%=df.getFieldValue("distributionfirstdiscount")%>"/>
                        </div></td>
                </tr>
                <tr>
                    <td width="135" bgcolor="#FDFDFD"><div align="right">二级分销：</div></td>
                    <td width="828" bgcolor="#FDFDFD"><div align="left">
                            <input name="distributionseconddiscount" type="text" id="distributionseconddiscount" style="width:246px; border:1px solid #666666;" maxlength="250"  value="<%=df.getFieldValue("distributionseconddiscount")%>"/>
                        </div></td>
                </tr>
                <tr>
                    <td width="135" bgcolor="#FDFDFD"><div align="right">三级分销：</div></td>
                    <td width="828" bgcolor="#FDFDFD"><div align="left">
                            <input name="distributionthirddiscount" type="text" id="distributionthirddiscount" style="width:246px; border:1px solid #666666;" maxlength="250"  value="<%=df.getFieldValue("distributionthirddiscount")%>"/>
                        </div></td>
                </tr>

                <!--                <tr>
                                     <td align="right" bgcolor="#FDFDFD">Tag：</td>
                                    <td align="right" bgcolor="#FDFDFD">    首页位置：</td>
                
                                    <td bgcolor="#FDFDFD">
                                        <select name="IsNew" id="IsNew">
                                            <option value="1" <%if (df.getInt("IsNew") == 1) {
                                                    out.print(" selected=\"selected\"");
                                                }%>>NO</option>
                                            <option value="2" <%if (df.getInt("IsNew") == 2) {
                                                    out.print(" selected=\"selected\"");
                                                }%>>首页</option>
                ...
                <tr>
                    ...
                    <td bgcolor="#FDFDFD">
                        <input type="text" name="IsRem" id="IsRem" value="<%=df.getInt("IsRem")%>" />
                        <!--快递费用：￥<input type="text" name="KuaiDi" id="KuaiDi" value="<%=df.getFloat("KuaiDi")%>" />*只能接收数值如12.00；0.00为免运费
                        *以上数据请不要含有符号“，”
                ...
                <tr>
                    ...
                    <td bgcolor="#FDFDFD">
                        <input type="tel" name="JiangShi" id="JiangShi" value="<%=df.getInt("JiangShi")%>" />
                    </td>
                </tr>
                <!--  <tr>
                      <td align="right" bgcolor="#FDFDFD">关键字：</td>
                      <td bgcolor="#FDFDFD"><textarea name="Keywords" cols="45" rows="5" class="textarea_normal" id="Keywords"><%=df.getString("Keywords")%></textarea></td>
                  </tr>-->
                <!--                <tr>
                                    <td align="right" bgcolor="#FDFDFD">描述：</td>
                                    <td bgcolor="#FDFDFD"><textarea name="Descr" cols="45" rows="5" class="textarea_normal" id="Descr"><%=df.getString("Descr")%></textarea></td>
                                </tr>-->
                <!--  <tr>
                      <td align="right" bgcolor="#FDFDFD">用途：</td>
                      <td bgcolor="#FDFDFD"><textarea name="YongTu" cols="45" rows="5" class="textarea_normal" id="YongTu"><%=df.getString("YongTu")%></textarea></td>
                  </tr>-->
                <tr>
                    <td align="right" bgcolor="#FDFDFD">备注：</td>
                    <td bgcolor="#FDFDFD"><textarea name="Remarks" cols="45" rows="5" class="textarea_normal" id="Remarks"><%=df.getString("Remarks")%></textarea></td>
                </tr>
                <!--                <tr>
                                    <td width="135" bgcolor="#FDFDFD"><div align="right">网页标题：</div></td>
                                    <td width="828" bgcolor="#FDFDFD"><div align="left">
                                            <input name="WebTitle" type="text" id="WebTitle" style="width:246px; border:1px solid #666666;" maxlength="250" value="<%=df.getString("WebTitle")%>" />
                                        </div></td>
                                </tr>
                                <tr>
                                    <td align="right" bgcolor="#FDFDFD">网页关键字：</td>
                                    <td bgcolor="#FDFDFD"><textarea name="WebKeywords" cols="45" rows="5" class="textarea_normal" id="WebKeywords"><%=df.getString("WebKeywords")%></textarea></td>
                                </tr>
                                <tr>
                                    <td align="right" bgcolor="#FDFDFD">网页描述：</td>
                                    <td bgcolor="#FDFDFD"><textarea name="WebDescr" cols="45" rows="5" class="textarea_normal" id="WebDescr"><%=df.getString("WebDescr")%></textarea></td>
                                </tr>-->
                <tr>
                    <td valign="top" bgcolor="#FDFDFD"><div align="right">商品详情：</div></td>
                    <td bgcolor="#FDFDFD">
                        <textarea name="Content" style="display:none; "><%=df.getString("Content")%></textarea>
