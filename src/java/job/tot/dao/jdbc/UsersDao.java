...
public class UsersDao extends AbstractDao {
    ...
    public DataField getById(int id,String fieldArr) {
        //String fieldArr = "id,svid,svname,sid,signid,wxsid";
        return getFirstData("select " + fieldArr + " from users where id='" + id + "'", fieldArr);
    }
    ...
    public boolean add(String svid, String svname, String sid, int signid, String wxsid) {
        ...
        String sql = "insert into users(svid,svname,sid,signid,wxsid) values(?,?,?,?,?)";
        try {
